<?php
/**
 * Centred footer: logo, menu and social links stacked in the middle.
 *
 * @package Mahan
 */
...
?>
<div class="mahan-footer__main mahan-footer__main--centered">
	<div class="mahan-container mahan-footer__centered">
